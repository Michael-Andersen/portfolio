...
class App extends React.Component {
  ...
  renderContentSections(sectionsP) {
    const sectionLinks = sectionsP.map((item) => {
      return (
  ...
  render() {
    ...
    const projects = [{title:"ImageMorpher", path: "/projects/imagemorpher", hasSubsection: false, comp: ImageMorpher}]
    const sectionsAndProjects =  sections.concat(projects);
    const contentSections = this.renderContentSections(sectionsAndProjects);
    return (
      <HashRouter>
